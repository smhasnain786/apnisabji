...
class _TrackOrderView extends StatelessWidget {
  const _TrackOrderView({super.key, required this.orderList, required this.index, required this.isReOrderAvailable});
...
class _OrderStatusCard extends StatelessWidget {
  const _OrderStatusCard({super.key, required this.orderList, required this.index});
