...
class CountryCodePickerWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return CountryCodePickerWidgetState(elements);
  }
}

class CountryCodePickerWidgetState extends State<CountryCodePickerWidget> {
  CountryCode? selectedItem;
  List<CountryCode> elements = [];
  List<CountryCode> favoriteElements = [];

  CountryCodePickerWidgetState(this.elements);
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.builder != null) {
      internalWidget = InkWell(
        onTap: showCountryCodePickerWidgetDialog,
      ...
      internalWidget = TextButton(
        ...
        onPressed: widget.enabled ? showCountryCodePickerWidgetDialog : null,
        child: Flex(
  ...
  @override
  void didUpdateWidget(CountryCodePickerWidget oldWidget) {
  ...
  void showCountryCodePickerWidgetDialog() async {
