...
class TitleWithTimeWidget extends StatelessWidget {
  ...
  const TitleWithTimeWidget({super.key, required this.title, this.onTap, this.eventDuration, this.isDetailsPage});
...
class TimerBox extends StatelessWidget {
  ...
  const TimerBox({super.key, required this.time, this.isBorder = false, this.day});
